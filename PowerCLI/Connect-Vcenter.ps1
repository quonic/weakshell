...
# Edit the $ServerList to include your vCenter's
# Running this will pop up a dialog that you can multi select what server you want to connect to.
#
# Requires PowerCLI to be installed.
...
$objListbox.SelectedItems | ForEach-Object {
